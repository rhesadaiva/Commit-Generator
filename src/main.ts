...
export async function main() {
  ...
  try {
    ...
    Logger.delimiter();
    Logger.section("Commit message", message);
    Logger.section("Commit description", description);
    Logger.delimiter();
    ...
    switch (confirmOption) {
      case "use":
        await GitService.createCommit(message, description);
      ...
      case "edit": {
        ...
        try {
          ...
          await GitService.commitWithMessageFile(tempFile);
